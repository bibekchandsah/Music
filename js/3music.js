...
function initializeMusicPlayer() {
    // Declare ulTag within the function
    const ulTag = wrapper.querySelector("ul");

    // Your existing code for loading music and rendering cards
    ...
    // Event listeners for clicking on a song in the list
...
//         // After metadata is loaded, you can update the UI or play the audio
//         // playMusic();
//     });
// }
...
//     // Save current music information to local storage
//     saveToLocalStorage(indexNumb);
// }
...
//         // Remove loading icon and show play icon
...
// // Function to save current music information to local storage
// function saveToLocalStorage(indexNumb) {
//     const currentMusic = {
//         index: indexNumb,
...
//     wrapper.classList.add("paused");
//     playPauseBtn.querySelector("i").innerText = "pause";
//     mainAudio.play().catch(function (error) {
//         // Handle the play interruption error
//         console.error("Play request interrupted:", error);
//     });
// }
...
//     // Check if inner text is neither "play_arrow" nor "pause" before applying rotation
...
//         musicList.classList.toggle("show");
//     } else if (!musicList.contains(e.target)) {
//         // Close music list when clicked outside
//         closemoreMusic.click();
//     }
//     closemoreMusic.addEventListener("click", () => {
//         moreMusicBtn.click();
//     });
...
function renderMusicList() {
    ...
    //               </div>
    //               <span class="audio-duration" data-duration="3:40"></span>
...
// Call the renderMusicList function when the window loads
// window.addEventListener("load", () => {
//     renderMusicList();
