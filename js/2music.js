...
function initializeMusicPlayer() {
  ...
  // progressArea.addEventListener("click", updateProgressBar);

  // Event listener for changing loop, shuffle, repeat icon onclick
  // repeatBtn.addEventListener("click", changeRepeatMode);

  // Event listener for when the song ends
  // mainAudio.addEventListener("ended", handleSongClick);

  // Event listener for showing/hiding the music list
...
// Function to handle a song click in the list
...
// play or pause button event// Function to toggle play/pause
